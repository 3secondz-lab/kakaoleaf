	...
	L.TileLayer.KoreaProvider.providers = {
		...
		DaumMap: {
			...
			options: {
				...
				tms: true,
				attribution: 'kakaomap &copy; <a target="_blank" href="http://map.kakao.com/" style="float: right; width: 38px; height: 17px; cursor: pointer;"><img src="https://map.kakao.com/favicon.ico"  style="width: 18px; height: 18px; border: none;"></a>'
			},
			variants: {
